...
@WebServlet(name = "GetMyWonListingServlet", urlPatterns = {"/GetMyWonListingServlet"})
public class GetMyWonListingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("bidWon", bid);
